...
class DataConfig:
    ...
    def get_data_config(self, data_name):
        ...
        if data_name == 'LEVIR':
            ...
            self.root_dir = '/home/yanghualin/zhangwen/LEVIR-CD256/'
        elif data_name == 'DSIFN':
            self.label_transform = "norm"
            self.root_dir = '/home/yanghualin/zhangwen/DSIFN_256/'
        elif data_name == 'WHU':
            self.label_transform = "norm"
            self.root_dir = '/home/yanghualin/zhangwen/WHU-CD-256/'
        elif data_name == 'CDD':
            self.label_transform = "norm"
            self.root_dir = '/home/yanghualin/zhangwen/CDD-CD-256/'
        elif data_name == 'TYPO':
            self.label_transform = "norm"
